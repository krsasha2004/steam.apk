...
public class ImageLoader {
    ...
    class C00962 implements Listener<Bitmap> {
    ...
    class C00973 implements ErrorListener {
        final /* synthetic */ String val$cacheKey;
    ...
    protected Request<Bitmap> makeImageRequest(String requestUrl, int maxWidth, int maxHeight, String cacheKey) {
        return new ImageRequest(requestUrl, new C00962(cacheKey), maxWidth, maxHeight, Config.RGB_565, new C00973(cacheKey));
    }
