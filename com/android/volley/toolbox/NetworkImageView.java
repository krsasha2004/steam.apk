...
public class NetworkImageView extends ImageView {
    ...
    class C01001 implements ImageListener {
        ...
        class C00991 implements Runnable {
            ...
            C00991(ImageContainer imageContainer) {
                this.val$response = imageContainer;
            }

            public void run() {
                C01001.this.onResponse(this.val$response, false);
            }
        }
        ...
        public void onResponse(ImageContainer response, boolean isImmediate) {
            if (isImmediate && this.val$isInLayoutPass) {
                NetworkImageView.this.post(new C00991(response));
    ...
    void loadImageIfNecessary(boolean isInLayoutPass) {
        ...
        if (width != 0 || height != 0 || isFullyWrapContent) {
            ...
            this.mImageContainer = this.mImageLoader.get(this.mUrl, new C01001(isInLayoutPass), maxWidth, maxHeight);
        }
    }
