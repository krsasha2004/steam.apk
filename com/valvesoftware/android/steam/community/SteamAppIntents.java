...
public class SteamAppIntents {
    public static String chatPartnerAvatarUrlKey;
    public static String chatPartnerPersonaNameKey;
    public static String notificationId;

    static {
        chatPartnerAvatarUrlKey = "chatPartnerAvatarUrl";
        chatPartnerPersonaNameKey = "chatPartnerPersonaNameKey";
    ...
    public static Intent helpURLIntent(Context context, String path) {
        return mainActivityIntent(context, SteamAppUri.createSteamAppWebUri(Config.URL_HELP_BASE + path));
    }
