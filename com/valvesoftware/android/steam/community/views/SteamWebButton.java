...
public class SteamWebButton extends LinearLayout {
    ...
    public SteamWebButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray a = context.obtainStyledAttributes(attrs, C0151R.styleable.SteamWebButton, 0, 0);
        ...
        ((LayoutInflater) context.getSystemService("layout_inflater")).inflate(C0151R.layout.steam_web_button, this, true);
        TextView textView = (TextView) findViewById(C0151R.id.fake_button_text);
        this.detailTextView = (TextView) findViewById(C0151R.id.fake_button_detail);
        View topBorder = findViewById(C0151R.id.top_border);
        View bottomBorder = findViewById(C0151R.id.bottom_border);
