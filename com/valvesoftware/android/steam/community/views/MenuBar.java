...
public class MenuBar extends LinearLayout {
    ...
    public MenuBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        ((LayoutInflater) context.getSystemService("layout_inflater")).inflate(C0151R.layout.menu_bar, this, true);
        this.hamburgerButton = (Button) findViewById(C0151R.id.hamburgerButton);
        this.titleTextView = (TextView) findViewById(C0151R.id.titleLabel);
        this.searchButton = (Button) findViewById(C0151R.id.titleNavSearchButton);
        this.refreshButton = (Button) findViewById(C0151R.id.titleNavRefreshButton);
        this.progressBar = (ProgressBar) findViewById(C0151R.id.titleProgressBar);
        this.extraMenuButton = (ImageButton) findViewById(C0151R.id.titleExtraButton);
    }
