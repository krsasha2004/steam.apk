...
public class TwoFactorCodeThermometerView extends View {
    ...
    public TwoFactorCodeThermometerView(Context context, AttributeSet attrs) {
        ...
        this.mOutlinePaint.setColor(getResources().getColor(C0151R.color.twofactorcode_thermometer_outline));
        this.mOutlinePaint.setStrokeWidth(3.0f);
        this.mOutlinePaint.setStyle(Style.STROKE);
        this.mBackgroundPaint = new Paint();
        this.mBackgroundPaint.setColor(getResources().getColor(C0151R.color.twofactorcode_thermometer_background));
        this.mBackgroundPaint.setStrokeWidth(3.0f);
        this.mBackgroundPaint.setStyle(Style.FILL);
        this.mNormalPaint = new Paint();
        this.mNormalPaint.setColor(getResources().getColor(C0151R.color.twofactorcode_thermometer_normal));
        this.mNormalPaint.setStyle(Style.FILL);
        this.mAlertPaint = new Paint();
        this.mAlertPaint.setColor(getResources().getColor(C0151R.color.twofactorcode_alert));
