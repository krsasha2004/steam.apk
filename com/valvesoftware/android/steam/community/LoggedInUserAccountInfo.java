...
public class LoggedInUserAccountInfo {
    ...
    static class C01461 extends ResponseListener {
        final /* synthetic */ SteamWebView val$steamWebView;

        C01461(SteamWebView steamWebView) {
            this.val$steamWebView = steamWebView;
        }
    ...
    public static void resetAllCookies() {
        ...
        s_strLanguage = SteamCommunityApplication.GetInstance().getString(C0151R.string.DO_NOT_LOCALIZE_COOKIE_Steam_Language);
        setCookie2("Steam_Language", s_strLanguage);
    }

    public static void updateLanguage() {
        String strSelectedLanguage = SteamCommunityApplication.GetInstance().getString(C0151R.string.DO_NOT_LOCALIZE_COOKIE_Steam_Language);
    ...
    public static void reacquireWGTokenFromServer(SteamWebView steamWebView) {
        ...
        if (s_lLastWGTokenFailureMS <= 0 || s_lLastWGTokenFailureMS + 5000 <= System.currentTimeMillis()) {
            ...
            requestBuilder.setResponseListener(new C01461(steamWebView));
