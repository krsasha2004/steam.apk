...
public class UserNotificationCounts {
    public static final int MAX_NOTIFICATION_TYPES;
    private final int[] m_rgNotificationCounts;
    ...
    public enum EUserNotification {
        ...
        k_EUserNotificationMax(10, false);
    ...
    static {
        MAX_NOTIFICATION_TYPES = EUserNotification.k_EUserNotificationMax.value;
    }

    public UserNotificationCounts() {
        this.m_rgNotificationCounts = new int[MAX_NOTIFICATION_TYPES];
    }
