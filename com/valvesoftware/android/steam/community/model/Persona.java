...
public class Persona {
    private PersonaStateCategoryInList categoryInList;
    ...
    public PersonaRelationship relationship;
    public String smallAvatarUrl;
    public String steamId;
    private long twoDaysInSeconds;

    public Persona() {
        this.personaState = PersonaState.OFFLINE;
        this.relationship = PersonaRelationship.none;
        this.currentGameString = "";
        this.lastOnlineTime = 0;
        this.twoDaysInSeconds = 172800;
