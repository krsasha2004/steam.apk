...
public class ActivityHelper {
    public static void UpdateToggleButtonStyles(ToggleButton btn) {
        int residColor = C0151R.color.primary_foreground_dim;
        int residBgColor = C0151R.color.secondary_background;
        int fontStyle = 0;
        if (btn.isChecked()) {
            residColor = C0151R.color.primary_foreground;
            residBgColor = C0151R.color.primary_background;
            fontStyle = 1;
        }
