...
public class TabbedSteamWebViewFragment extends WebViewFragment {
    ...
    /* renamed from: com.valvesoftware.android.steam.community.fragment.TabbedSteamWebViewFragment.1 */
    ...
    /* renamed from: com.valvesoftware.android.steam.community.fragment.TabbedSteamWebViewFragment.2 */
    class C02642 extends ResponseListener {
        C02642() {
        }
    ...
    public TabbedSteamWebViewFragment() {
        this.m_selectedTab = 0;
        this.m_toggleListener = new C02631();
    }

    static {
        m_categoryButtons = new int[]{C0151R.id.web_select_1, C0151R.id.web_select_2, C0151R.id.web_select_3, C0151R.id.web_select_4, C0151R.id.web_select_5, C0151R.id.web_select_6, C0151R.id.web_select_7, C0151R.id.web_select_8};
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ((RadioGroup) view.findViewById(C0151R.id.toggleGroup)).setOnCheckedChangeListener(this.m_toggleListener);
        this.btnLayout = (LinearLayout) view.findViewById(C0151R.id.web_select_layout);
        return view;
    }

    private void setCategoriesFailed() {
        this.m_webView.setViewContentsShowFailure(SteamAppUri.catalog().toString(), SteamCommunityApplication.GetInstance().getString(C0151R.string.Web_Error_Reload));
    }
    ...
    private void getCategoryUrlInfo(String url) {
        ...
        requestBuilder.setResponseListener(new C02642());
