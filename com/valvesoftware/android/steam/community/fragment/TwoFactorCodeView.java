...
public class TwoFactorCodeView extends LinearLayout implements CloseableView {
    ...
    /* renamed from: com.valvesoftware.android.steam.community.fragment.TwoFactorCodeView.1 */
    ...
    public TwoFactorCodeView(Context context, AttributeSet attrs) {
        ...
        this.updateRunnable = new C02671();
        ((LayoutInflater) context.getSystemService("layout_inflater")).inflate(C0151R.layout.twofactor_code_fragment, this, true);
        setLayoutParams(new LayoutParams(getScreenWidth(), -1));
        this.mNormalColor = getResources().getColor(C0151R.color.twofactorcode_normal);
        this.mDangerColor = getResources().getColor(C0151R.color.twofactorcode_alert);
        this.mCode = (TextView) findViewById(C0151R.id.twofactorcode_code);
        this.mAccountName = (TextView) findViewById(C0151R.id.twofactorcode_account_name);
        this.mThermometer = (TwoFactorCodeThermometerView) findViewById(C0151R.id.twofactorcode_thermometer);
        this.mValveTime = (TextView) findViewById(C0151R.id.twofactorcode_valvetime);
    }
    ...
    public void update() {
        ...
        if (token != null) {
            ...
            enableArrow(C0151R.id.twofactor_back, this.bEnableBackArrow);
            enableArrow(C0151R.id.twofactor_forward, this.bEnableForwardArrow);
