...
public class NavDrawerNotificationItem extends NavDrawerItem {
    ...
    public static class NavDrawerGroupItem extends NavDrawerNotificationItem {
        ...
        public void setNotificationCount(int notificationCount) {
            ...
            if (this.m_view != null) {
                TextView navNotificationCount = (TextView) this.m_view.findViewById(C0151R.id.nav_item_notification_count);
                View navNotificationCtn = this.m_view.findViewById(C0151R.id.nav_item_notification_count_ctn);
    ...
    public void setNotificationCount(int notificationCount) {
        this.m_notificationCount = notificationCount;
        if (this.m_view != null) {
            TextView navItemName = (TextView) this.m_view.findViewById(C0151R.id.nav_item_name);
