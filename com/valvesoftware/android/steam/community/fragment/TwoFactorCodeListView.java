...
public class TwoFactorCodeListView extends FrameLayout {
    ...
    /* renamed from: com.valvesoftware.android.steam.community.fragment.TwoFactorCodeListView.1 */
    ...
    /* renamed from: com.valvesoftware.android.steam.community.fragment.TwoFactorCodeListView.2 */
    ...
    public TwoFactorCodeListView(Context context, AttributeSet attrs) {
        ...
        this.timeCorrectorTask = new C02651();
        View view = ((LayoutInflater) context.getSystemService("layout_inflater")).inflate(C0151R.layout.twofactor_code_list_fragment, this, true);
        this.pagingHorizontalScrollView = (PagingHorizontalScrollView) view.findViewById(C0151R.id.twofactor_code_fragment_horizontalscroller);
        this.pagingHorizontalScrollView.init();
        this.twoFactorPlaceholder = view.findViewById(C0151R.id.two_factor_placeholder);
        TypedArray a = context.obtainStyledAttributes(attrs, C0151R.styleable.TwoFactorCodeListFragment, 0, 0);
        this.invisibleIfNoCodes = a.getBoolean(0, false);
        a.recycle();
        this.receiver = new C02662();
        if (isInEditMode()) {
