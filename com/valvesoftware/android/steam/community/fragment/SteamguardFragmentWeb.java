...
public class SteamguardFragmentWeb extends Fragment implements IBackButtonSupport {
    ...
    /* renamed from: com.valvesoftware.android.steam.community.fragment.SteamguardFragmentWeb.1 */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(C0151R.layout.steamguard_fragment_web, container, false);
        this.twoFactorContainer = (FrameLayout) view.findViewById(C0151R.id.twofactor_container);
        this.twoFactorCodeListView = (TwoFactorCodeListView) view.findViewById(C0151R.id.two_factor_code_view);
        LinearLayout webViewContainer = (LinearLayout) view.findViewById(C0151R.id.webview_container);
    ...
    public void onResume() {
        super.onResume();
        this.receiver = new C02621();
        TimeCorrector.getInstance().hintSync();
        if (ActivityHelper.fragmentIsActive(this)) {
            getActivity().setTitle(C0151R.string.steamguard_steam_guard);
        }
