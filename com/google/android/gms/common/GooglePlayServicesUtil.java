...
public final class GooglePlayServicesUtil {
    ...
    public static int isGooglePlayServicesAvailable(Context context) {
        ...
        try {
            if (m4a(packageManager.getPackageInfo("com.android.vending", 64), f4C) == null) {
                Log.w("GooglePlayServicesUtil", "Google Play Store signature invalid.");
                return 9;
            }
            try {
                PackageInfo packageInfo = packageManager.getPackageInfo("com.google.android.gms", 64);
                if (m4a(packageInfo, r4) == null) {
                    Log.w("GooglePlayServicesUtil", "Google Play services signature invalid.");
                    return 9;
                } else if (packageInfo.versionCode < 3159100) {
                    Log.w("GooglePlayServicesUtil", "Google Play services out of date.  Requires 3159100 but found " + packageInfo.versionCode);
                    return 2;
                } else {
                    try {
