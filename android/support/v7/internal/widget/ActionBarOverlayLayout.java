...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent {
    ...
    class C00671 extends ViewPropertyAnimatorListenerAdapter {
        C00671() {
        }
    ...
    class C00682 extends ViewPropertyAnimatorListenerAdapter {
        C00682() {
        }
    ...
    static {
        ATTRS = new int[]{C0057R.attr.actionBarSize, 16842841};
    }
    ...
    public ActionBarOverlayLayout(Context context) {
        ...
        this.mTopAnimatorListener = new C00671();
        this.mBottomAnimatorListener = new C00682();
        this.mRemoveActionBarHideOffset = new C00693();
        this.mAddActionBarHideOffset = new C00704();
        init(context);
    }
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0057R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0057R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0057R.id.action_bar));
            this.mActionBarBottom = (ActionBarContainer) findViewById(C0057R.id.split_action_bar);
        }
    }
