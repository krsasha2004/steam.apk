...
class SpinnerCompat extends AbsSpinnerCompat implements OnClickListener {
    ...
    class C00731 extends ForwardingListener {
        final /* synthetic */ DropdownPopup val$popup;

        C00731(View x0, DropdownPopup dropdownPopup) {
    ...
    class C00742 implements OnGlobalLayoutListener {
        C00742() {
        }
    ...
    private class DropdownPopup extends ListPopupWindow implements SpinnerPopup {
        ...
        class C00751 implements OnItemClickListener {
            final /* synthetic */ SpinnerCompat val$this$0;

            C00751(SpinnerCompat spinnerCompat) {
        ...
        public DropdownPopup(Context context, AttributeSet attrs, int defStyleAttr) {
            ...
            setModal(true);
            setPromptPosition(0);
            setOnItemClickListener(new C00751(SpinnerCompat.this));
        }
    ...
    SpinnerCompat(Context context, AttributeSet attrs, int defStyle, int mode) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0057R.styleable.Spinner, defStyle, 0);
        setBackgroundDrawable(a.getDrawable(C0057R.styleable.Spinner_android_background));
        if (mode == -1) {
            mode = a.getInt(C0057R.styleable.Spinner_spinnerMode, 0);
        }
        switch (mode) {
            ...
            case C0151R.styleable.View_paddingStart /*1*/:
                ...
                this.mDropDownWidth = a.getLayoutDimension(C0057R.styleable.Spinner_android_dropDownWidth, -2);
                popup.setBackgroundDrawable(a.getDrawable(C0057R.styleable.Spinner_android_popupBackground));
                this.mPopup = popup;
                this.mForwardingListener = new C00731(this, popup);
                break;
        }
        this.mGravity = a.getInt(C0057R.styleable.Spinner_android_gravity, 17);
        this.mPopup.setPromptText(a.getString(C0057R.styleable.Spinner_prompt));
        this.mDisableChildrenWhenDisabled = a.getBoolean(C0057R.styleable.Spinner_disableChildrenWhenDisabled, false);
        a.recycle();
    ...
    public void onRestoreInstanceState(Parcelable state) {
        ...
        if (ss.showDropdown) {
            ...
            if (vto != null) {
                vto.addOnGlobalLayoutListener(new C00742());
            }
        }
    }
}
