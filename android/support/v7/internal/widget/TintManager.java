...
public class TintManager {
    ...
    static {
        ...
        TINT_COLOR_CONTROL_NORMAL = new int[]{C0057R.drawable.abc_ic_ab_back_mtrl_am_alpha, C0057R.drawable.abc_ic_go_search_api_mtrl_alpha, C0057R.drawable.abc_ic_search_api_mtrl_alpha, C0057R.drawable.abc_ic_commit_search_api_mtrl_alpha, C0057R.drawable.abc_ic_clear_mtrl_alpha, C0057R.drawable.abc_ic_menu_share_mtrl_alpha, C0057R.drawable.abc_ic_menu_copy_mtrl_am_alpha, C0057R.drawable.abc_ic_menu_cut_mtrl_alpha, C0057R.drawable.abc_ic_menu_selectall_mtrl_alpha, C0057R.drawable.abc_ic_menu_paste_mtrl_am_alpha, C0057R.drawable.abc_ic_menu_moreoverflow_mtrl_alpha, C0057R.drawable.abc_ic_voice_search_api_mtrl_alpha, C0057R.drawable.abc_textfield_search_default_mtrl_alpha, C0057R.drawable.abc_textfield_default_mtrl_alpha};
        TINT_COLOR_CONTROL_ACTIVATED = new int[]{C0057R.drawable.abc_textfield_activated_mtrl_alpha, C0057R.drawable.abc_textfield_search_activated_mtrl_alpha, C0057R.drawable.abc_cab_background_top_mtrl_alpha};
        TINT_COLOR_BACKGROUND_MULTIPLY = new int[]{C0057R.drawable.abc_popup_background_mtrl_mult, C0057R.drawable.abc_cab_background_internal_bg, C0057R.drawable.abc_menu_hardkey_panel_mtrl_mult};
        TINT_COLOR_CONTROL_STATE_LIST = new int[]{C0057R.drawable.abc_edit_text_material, C0057R.drawable.abc_tab_indicator_material, C0057R.drawable.abc_textfield_search_material, C0057R.drawable.abc_spinner_mtrl_am_alpha, C0057R.drawable.abc_btn_check_material, C0057R.drawable.abc_btn_radio_material};
        CONTAINERS_WITH_TINT_CHILDREN = new int[]{C0057R.drawable.abc_cab_background_top_material};
    }
    ...
    public Drawable getDrawable(int resId) {
        ...
        if (resId == C0057R.drawable.abc_switch_track_mtrl_alpha) {
            return new TintDrawableWrapper(drawable, getSwitchTrackColorStateList());
        }
        if (resId == C0057R.drawable.abc_switch_thumb_material) {
    ...
    void tintDrawable(int resId, Drawable drawable) {
        ...
        if (arrayContains(TINT_COLOR_CONTROL_NORMAL, resId)) {
            colorAttr = C0057R.attr.colorControlNormal;
            colorAttrSet = true;
        } else if (arrayContains(TINT_COLOR_CONTROL_ACTIVATED, resId)) {
            colorAttr = C0057R.attr.colorControlActivated;
            colorAttrSet = true;
        } else if (arrayContains(TINT_COLOR_BACKGROUND_MULTIPLY, resId)) {
            colorAttr = 16842801;
            colorAttrSet = true;
            tintMode = Mode.MULTIPLY;
        } else if (resId == C0057R.drawable.abc_list_divider_mtrl_alpha) {
            colorAttr = 16842800;
            colorAttrSet = true;
    ...
    private ColorStateList getDefaultColorStateList() {
        if (this.mDefaultColorStateList == null) {
            int colorControlNormal = getThemeAttrColor(C0057R.attr.colorControlNormal);
            int colorControlActivated = getThemeAttrColor(C0057R.attr.colorControlActivated);
            int[][] states = new int[7][];
            colors = new int[7];
            states[0] = new int[]{-16842910};
            colors[0] = getDisabledThemeAttrColor(C0057R.attr.colorControlNormal);
            int i = 0 + 1;
    ...
    private ColorStateList getSwitchTrackColorStateList() {
        if (this.mSwitchTrackStateList == null) {
            ...
            int i = 0 + 1;
            states[i] = new int[]{16842912};
            colors[i] = getThemeAttrColor(C0057R.attr.colorControlActivated, 0.3f);
            i++;
            states[i] = new int[0];
    ...
    private ColorStateList getSwitchThumbColorStateList() {
        if (this.mSwitchThumbStateList == null) {
            ...
            colors = new int[3];
            states[0] = new int[]{-16842910};
            colors[0] = getDisabledThemeAttrColor(C0057R.attr.colorSwitchThumbNormal);
            int i = 0 + 1;
            states[i] = new int[]{16842912};
            colors[i] = getThemeAttrColor(C0057R.attr.colorControlActivated);
            i++;
            states[i] = new int[0];
            colors[i] = getThemeAttrColor(C0057R.attr.colorSwitchThumbNormal);
