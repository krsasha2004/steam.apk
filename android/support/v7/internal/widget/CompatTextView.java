...
public class CompatTextView extends TextView {
    ...
    public CompatTextView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray style = context.obtainStyledAttributes(attrs, C0057R.styleable.CompatTextView, defStyle, 0);
        boolean allCaps = style.getBoolean(C0057R.styleable.CompatTextView_textAllCaps, false);
        style.recycle();
        if (allCaps) {
