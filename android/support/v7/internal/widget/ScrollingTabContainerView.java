...
public class ScrollingTabContainerView extends HorizontalScrollView implements OnItemClickListener {
    ...
    private class TabView extends LinearLayoutCompat implements OnLongClickListener {
        ...
        public TabView(Context context, Tab tab, boolean forList) {
            ...
            this.mTab = tab;
            TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, null, this.BG_ATTRS, C0057R.attr.actionBarTabStyle, 0);
            if (a.hasValue(0)) {
        ...
        public void update() {
            ...
            if (hasText) {
                if (this.mTextView == null) {
                    TextView textView = new CompatTextView(getContext(), null, C0057R.attr.actionBarTabTextStyle);
    ...
    private SpinnerCompat createSpinner() {
        SpinnerCompat spinner = new SpinnerCompat(getContext(), null, C0057R.attr.actionDropDownStyle);
    ...
    public void animateToTab(int position) {
        ...
        this.mTabSelector = new C00721(tabView);
