...
public abstract class AdapterViewCompat<T extends Adapter> extends ViewGroup {
    ...
    long mSelectedRowId;
    private android.support.v7.internal.widget.AdapterViewCompat$android.support.v7.internal.widget.AdapterViewCompat$android.support.v7.internal.widget.AdapterViewCompat$android.support.v7.internal.widget.AdapterViewCompat.SelectionNotifier mSelectionNotifier;
    int mSpecificTop;
    long mSyncHeight;
    int mSyncMode;
    int mSyncPosition;
