...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    class C00601 extends ViewPropertyAnimatorListenerAdapter {
        C00601() {
        }
    ...
    class C00623 implements ViewPropertyAnimatorUpdateListener {
        C00623() {
        }
    ...
    public WindowDecorActionBar(ActionBarActivity activity, boolean overlayMode) {
        ...
        this.mHideListener = new C00601();
        this.mShowListener = new C00612();
        this.mUpdateListener = new C00623();
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0057R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0057R.id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0057R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0057R.id.action_bar_container);
        this.mSplitView = (ActionBarContainer) decor.findViewById(C0057R.id.split_action_bar);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, C0057R.styleable.ActionBar, C0057R.attr.actionBarStyle, 0);
        if (a.getBoolean(C0057R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0057R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0057R.attr.actionBarWidgetTheme, outValue, true);
