...
abstract class ActionBarActivityDelegate {
    ...
    class C00501 implements WindowCallback {
        C00501() {
        }
    ...
    ActionBarActivityDelegate(ActionBarActivity activity) {
        this.mDefaultWindowCallback = new C00501();
    ...
    void onCreate(Bundle savedInstanceState) {
        ...
        if (a.hasValue(C0057R.styleable.Theme_windowActionBar)) {
            if (a.getBoolean(C0057R.styleable.Theme_windowActionBar, false)) {
                this.mHasActionBar = true;
            }
            if (a.getBoolean(C0057R.styleable.Theme_windowActionBarOverlay, false)) {
                this.mOverlayActionBar = true;
            }
            if (a.getBoolean(C0057R.styleable.Theme_windowActionModeOverlay, false)) {
                this.mOverlayActionMode = true;
            }
            this.mIsFloating = a.getBoolean(C0057R.styleable.Theme_android_windowIsFloating, false);
            a.recycle();
            return;
        }
        a.recycle();
