...
public class Toolbar extends ViewGroup {
    ...
    class C00871 implements android.support.v7.widget.ActionMenuView.OnMenuItemClickListener {
        C00871() {
        }
    ...
    class C00893 implements OnClickListener {
        C00893() {
        }
    ...
    public Toolbar(Context context, AttributeSet attrs) {
        this(context, attrs, C0057R.attr.toolbarStyle);
    }
    ...
    public Toolbar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mMenuViewItemClickListener = new C00871();
        this.mShowOverflowMenuRunnable = new C00882();
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(getContext(), attrs, C0057R.styleable.Toolbar, defStyleAttr, 0);
        this.mTitleTextAppearance = a.getResourceId(C0057R.styleable.Toolbar_titleTextAppearance, 0);
        this.mSubtitleTextAppearance = a.getResourceId(C0057R.styleable.Toolbar_subtitleTextAppearance, 0);
        this.mGravity = a.getInteger(C0057R.styleable.Toolbar_android_gravity, this.mGravity);
        this.mButtonGravity = 48;
        int dimensionPixelOffset = a.getDimensionPixelOffset(C0057R.styleable.Toolbar_titleMargins, 0);
        this.mTitleMarginBottom = dimensionPixelOffset;
        this.mTitleMarginTop = dimensionPixelOffset;
        this.mTitleMarginEnd = dimensionPixelOffset;
        this.mTitleMarginStart = dimensionPixelOffset;
        int marginStart = a.getDimensionPixelOffset(C0057R.styleable.Toolbar_titleMarginStart, -1);
        if (marginStart >= 0) {
            this.mTitleMarginStart = marginStart;
        }
        int marginEnd = a.getDimensionPixelOffset(C0057R.styleable.Toolbar_titleMarginEnd, -1);
        if (marginEnd >= 0) {
            this.mTitleMarginEnd = marginEnd;
        }
        int marginTop = a.getDimensionPixelOffset(C0057R.styleable.Toolbar_titleMarginTop, -1);
        if (marginTop >= 0) {
            this.mTitleMarginTop = marginTop;
        }
        int marginBottom = a.getDimensionPixelOffset(C0057R.styleable.Toolbar_titleMarginBottom, -1);
        if (marginBottom >= 0) {
            this.mTitleMarginBottom = marginBottom;
        }
        this.mMaxButtonHeight = a.getDimensionPixelSize(C0057R.styleable.Toolbar_maxButtonHeight, -1);
        int contentInsetStart = a.getDimensionPixelOffset(C0057R.styleable.Toolbar_contentInsetStart, Integer.MIN_VALUE);
        int contentInsetEnd = a.getDimensionPixelOffset(C0057R.styleable.Toolbar_contentInsetEnd, Integer.MIN_VALUE);
        int contentInsetLeft = a.getDimensionPixelSize(C0057R.styleable.Toolbar_contentInsetLeft, 0);
        int contentInsetRight = a.getDimensionPixelSize(C0057R.styleable.Toolbar_contentInsetRight, 0);
        ...
        this.mCollapseIcon = a.getDrawable(C0057R.styleable.Toolbar_collapseIcon);
        this.mCollapseDescription = a.getText(C0057R.styleable.Toolbar_collapseContentDescription);
        CharSequence title = a.getText(C0057R.styleable.Toolbar_title);
        if (!TextUtils.isEmpty(title)) {
            setTitle(title);
        }
        CharSequence subtitle = a.getText(C0057R.styleable.Toolbar_subtitle);
        if (!TextUtils.isEmpty(subtitle)) {
            setSubtitle(subtitle);
        }
        this.mPopupContext = getContext();
        setPopupTheme(a.getResourceId(C0057R.styleable.Toolbar_popupTheme, 0));
        Drawable navIcon = a.getDrawable(C0057R.styleable.Toolbar_navigationIcon);
        if (navIcon != null) {
            setNavigationIcon(navIcon);
        }
        CharSequence navDesc = a.getText(C0057R.styleable.Toolbar_navigationContentDescription);
        if (!TextUtils.isEmpty(navDesc)) {
            setNavigationContentDescription(navDesc);
        }
        this.mMinHeight = a.getDimensionPixelSize(C0057R.styleable.Toolbar_android_minHeight, 0);
        a.recycle();
    ...
    private void ensureNavButtonView() {
        if (this.mNavButtonView == null) {
            this.mNavButtonView = new ImageButton(getContext(), null, C0057R.attr.toolbarNavigationButtonStyle);
            LayoutParams lp = generateDefaultLayoutParams();
    ...
    private void ensureCollapseButtonView() {
        if (this.mCollapseButtonView == null) {
            this.mCollapseButtonView = new ImageButton(getContext(), null, C0057R.attr.toolbarNavigationButtonStyle);
            ...
            this.mCollapseButtonView.setOnClickListener(new C00893());
        }
    }
    ...
    private int getChildTop(View child, int alignmentHeight) {
        ...
        switch (getChildVerticalGravity(lp.gravity)) {
            ...
            case C0151R.styleable.Theme_colorControlHighlight /*80*/:
    ...
    private static Context themifyContext(Context context, AttributeSet attrs, int defStyleAttr) {
        TypedArray a = context.obtainStyledAttributes(attrs, C0057R.styleable.Toolbar, defStyleAttr, 0);
        int themeId = a.getResourceId(C0057R.styleable.Toolbar_theme, 0);
        if (themeId != 0) {
