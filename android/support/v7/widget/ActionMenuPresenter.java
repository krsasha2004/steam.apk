...
public class ActionMenuPresenter extends BaseMenuPresenter implements SubUiVisibilityListener {
    ...
    private class ActionButtonSubmenu extends MenuPopupHelper {
        ...
        public ActionButtonSubmenu(Context context, SubMenuBuilder subMenu) {
            super(context, subMenu, null, false, C0057R.attr.actionOverflowMenuStyle);
    ...
    private class OverflowMenuButton extends TintImageView implements ActionMenuChildView {
        ...
        class C00811 extends ForwardingListener {
            final /* synthetic */ ActionMenuPresenter val$this$0;

            C00811(View x0, ActionMenuPresenter actionMenuPresenter) {
        ...
        public OverflowMenuButton(Context context) {
            ...
            setVisibility(0);
            setEnabled(true);
            setOnTouchListener(new C00811(this, ActionMenuPresenter.this));
        }
    ...
    private class OverflowPopup extends MenuPopupHelper {
        public OverflowPopup(Context context, MenuBuilder menu, View anchorView, boolean overflowOnly) {
            super(context, menu, anchorView, overflowOnly, C0057R.attr.actionOverflowMenuStyle);
            setGravity(8388613);
            setCallback(ActionMenuPresenter.this.mPopupPresenterCallback);
        }
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        if (!this.mMaxItemsSet) {
            this.mMaxItems = this.mContext.getResources().getInteger(C0057R.integer.abc_max_action_buttons);
        }
        if (this.mMenu != null) {
